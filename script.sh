...
eget nicocha30/ligolo-ng -s linux/amd64 --asset=agent --file=agent --upgrade-only --to ./bin/ligolo-ng
eget nicocha30/ligolo-ng -s linux/amd64 --asset=proxy --file=proxy --upgrade-only --to ./bin/ligolo-ng
